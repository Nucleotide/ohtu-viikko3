...
public class KassapaateTest {
    ...
    @Test
    public void kassapaateLataaKortilleRahaaJosAnnettuSummaOnPositiivinen() {
    ...
    @Test
    public void kassapaateEiLataaKorttiaNollalla() {
        kassa.lataa(kortti, 0);
        verify(kortti, times(0)).lataa(0);
    }
    
    @Test
    public void kassapaateEiLataaKorttiaNegatiivisella() {
